...
public class WeatherAppGui extends JFrame {
  ...
  private void addGuiComponents() {
    ...
    JLabel weatherConditionImage = new JLabel(loadImage("external/photos/clouds.png"));
    ...
    JLabel humidityImage = new JLabel(loadImage("external/photos/humidity.png"));
    ...
    JLabel windspeedImage = new JLabel(loadImage("external/photos/windspeed.png"));
    ...
    searchButton.addActionListener(e -> {
      ...
      switch (weatherCondition) {
        ...
        case "Rain":
          ...
          break;
        case "Snow":
          weatherConditionImage.setIcon(loadImage("external/photos/snow.pngImage"));
          break;
      }
